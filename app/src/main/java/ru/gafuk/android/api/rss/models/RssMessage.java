package ru.gafuk.android.api.rss.models;
...
public class RssMessage implements IRssMessage, Comparable<RssMessage> {
    ...
    @Override
    public int compareTo(@NonNull RssMessage anotherMessage) {
