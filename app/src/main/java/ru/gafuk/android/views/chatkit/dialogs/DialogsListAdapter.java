...
package ru.gafuk.android.views.chatkit.dialogs;
...
import ru.gafuk.android.views.chatkit.commons.ViewHolder;
    ...
    public void sortByLastMessageDate() {
        Collections.sort(items, new Comparator<DIALOG>() {
            ...
            public int compare(DIALOG o1, DIALOG o2) {
                if (o1.getLastMessage().getSenddate().after(o2.getLastMessage().getSenddate())) {
                    return -1;
                } else if (o1.getLastMessage().getSenddate().before(o2.getLastMessage().getSenddate())) {
                    return 1;
                } else return 0;
            }
        });
    ...
    * */
    ...
    public static class DialogViewHolder<DIALOG extends IDialog> extends BaseDialogViewHolder<DIALOG> {
        ...
        public void onBind(final DIALOG dialog) {
            ...
            //Set Name
            tvName.setText(dialog.getNickname());

            //Set Date
            String formattedDate = null;
            if (dialog.getLastMessage() != null) { // добавлена проверка
                Date lastMessageDate = dialog.getLastMessage().getSenddate();
            ...
            //Set Dialog avatar
            if (imageLoader != null) {
                imageLoader.loadImage(ivAvatar, dialog.getAvatar());
            }

            //Set Last message user avatar
            if (imageLoader != null && dialog.getLastMessage() != null) { // добавлена проверка
            ...
            tvBubble.setText(String.valueOf(dialog.getNew_messages()));
            tvBubble.setVisibility(dialogStyle.isDialogUnreadBubbleEnabled() &&
                    dialog.getNew_messages() > 0 ? VISIBLE : GONE);
