package ru.gafuk.android.views;
...
import ru.gafuk.android.fragments.jsinterfaces.IBase;
...
public class ExtendedWebView extends NestedGeckoView implements IBase{
    ...
    public void init() {
        ...
        // TODO: 07.11.2017 установка шрифта при изменении настроек setRelativeFontSize(Preferences.Main.getWebViewSize());
        // TODO: 07.11.2017 фон setBackgroundColor(App.getColorFromAttr(getContext(), R.attr.background_base));
    }
    ...
    * */
    ...
    protected void onCreateContextMenu(ContextMenu menu) {
        ...
        requestFocusNodeHref(new Handler(msg -> {
            ...
            // TODO: 26.09.2017 формирование контекстного меню DialogsHelper.handleContextMenu(getContext(), result.getType(), result.getExtra(), (String) msg.getData().get("url"));
            return true;
        }).obtainMessage());
    }
